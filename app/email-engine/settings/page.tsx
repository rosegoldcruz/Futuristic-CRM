    ...
    <MailShell user={user} title="Email Engine Settings">
      ...
      <Panel title="Environment">
        <div className="grid gap-2 text-xs md:grid-cols-2">
          {["EMAIL_DEFAULT_FROM", "EMAIL_DEFAULT_FROM_NAME", "EMAIL_PROVIDER", "SMTP_HOST", "SMTP_PORT", "SMTP_USER", "SMTP_PASS", "FILE_STORAGE_DRIVER", "FILE_STORAGE_ROOT", "N8N_WEBHOOK_URL"].map((name) => (
